...
class ProjectTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._post_test_data = {
            "project_name": "project_{random_num}".format(random_num=random.randint(1, 1000)),
            "project_description": "{random_uuid}".format(random_uuid=uuid.uuid4())
        }
    ...
    def test_get_single_project_success(self):
        ...
        project_id = 1
        resp = self.app_client.get('api/project?project_id={project_id}'.format(project_id=project_id))
        self.assertEqual(200, resp.status_code)
